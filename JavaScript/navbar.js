...
navBar.innerHTML = `
<nav class="navbar fixed-top navbar-expand navbar-light py-2">
      ...
      <div class="collapse navbar-collapse" id="navbarExample01">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li id="pag1" class="nav-item">
            <a class="nav-link" href="pag1.html">Tipus isomètric</a>
          </li>
          <li id="pag2" class="nav-item">
            <a class="nav-link" href="pag2.html">Tipus Top-Bottom</a>
          </li>
          <li id="pag3" class="nav-item">
            <a class="nav-link" href="pag3.html">Tipus 2D</a>
          </li>
        </ul>
      </div>
    </div>
